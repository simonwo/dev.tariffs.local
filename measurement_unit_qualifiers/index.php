                        ...
                        <div class="govuk-grid-column-full">
                            ...
                            <table class="govuk-table govuk-table--m sticky">
                                ...
                                <tbody class="govuk-table__body">
                                    <?php
                                    foreach ($application->measurement_unit_qualifiers as $measurement_unit_qualifier) {
                                    ?>
                                        <tr class="govuk-table__row">
                                            <td class="govuk-table__cell"><?= $measurement_unit_qualifier->measurement_unit_qualifier_code ?></td>
                                            <td class="govuk-table__cell"><?= $measurement_unit_qualifier->description ?></td>
                                            <td class="govuk-table__cell"><?= $measurement_unit_qualifier->validity_start_date ?></td>
                                            <td class="govuk-table__cell"><?= $measurement_unit_qualifier->validity_end_date ?></td>
                                        </tr>
                                    <?php
                                    }
                                    ?>
