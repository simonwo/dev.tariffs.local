<?php
	...
	require ("classes/goods_nomenclature.html");
...
?>
				<tr class="<?=$rowclass?>">
					...
					<td class="govuk-table__cell c"><a href="measure_type_view.html?measure_type_id=<?=$m->measure_type_id?>"><?=$m->measure_type_id?></a></td>
					<td class="govuk-table__cell c"><a href="geographical_area_view.html?geographical_area_id=<?=$m->geographical_area_id?>"><?=$m->geographical_area_id?></a></td>
					<td class="govuk-table__cell c"><?=$m->additional_code_type_id?><?=$m->additional_code_id?></td>
					<td class="govuk-table__cell c"><a href="regulation_view.html?regulation_id=<?=$m->regulation_id_full?>"><?=$m->regulation_id_full?></a></td>
