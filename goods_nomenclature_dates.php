...
<div class="app-content__header">
	<h1 class="govuk-heading-xl" style="margin:1em 0px 0px 0px">Edit commodity code start / end dates</h1>
</div>
...
<details class="govuk-details" data-module="govuk-details">
  ...
  <div class="govuk-details__text">
    ...
    <table class="govuk-table" cellspacing="0" style="xwidth:70%">
        <tr class="govuk-table__row" valign="top" style="vertical-align:top !important">
            <th class="govuk-table__header nopad" style="width:35%">Measure type</th>
        ...
        <tr class="govuk-table__row" valign="top">
            <td class="govuk-table__cell nopad">142 (Tariff preference)</td>
        ...
        <tr class="govuk-table__row" valign="top">
            <td class="govuk-table__cell nopad">771 (Import control of timber and timber products subject to the FLEGT licensing scheme)</td>
            <td class="govuk-table__cell">1011 (Erga Omnes)</td>
            <td class="govuk-table__cell">01 Sep 2012</td>
            <td class="govuk-table__cell">-</td>
        </tr>
    </table>
    <p>See <a href="#">all measures associated with this commodity code</a>.</p>
  </div>
</details>
...
<details class="govuk-details" data-module="govuk-details">
  ...
  <div class="govuk-details__text">
    ...
    <table class="govuk-table" cellspacing="0" style="xwidth:70%">
        <tr class="govuk-table__row" valign="top" style="vertical-align:top !important">
            <th class="govuk-table__header nopad" style="width:10%">Code</th>
        ...
        <tr class="govuk-table__row" valign="top">
            <td class="govuk-table__cell nopad">TN084</td>
    ...
    <p>See <a href="#">all footnotes associated with this commodity code</a>.</p>
  </div>
</details>
...
<div class="govuk-form-group <?=$error_handler->get_error("validity_start_date");?>" style="margin-top:2em">
	...
	associated with the commodity code, then you may be subject to conformance errors.
  </span>
