...
if ($application->mode == "insert") {
    ...
    $verb = "updated";
    $crumb_text = "Edit certificate description";
}
                ...
                <div class="govuk-grid-column-full">
                    ...
                    <div class="govuk-panel govuk-panel--confirmation">
                        <h1 class="govuk-panel__title">
                            The description for certificate <?= $certificate->certificate_type_code ?><?= $certificate->certificate_code ?> has been <?= $verb ?>.
                        </h1>
                    ...
                    <ul class="govuk-list">
                        ...
                        <li><a class="govuk-link" href="/certificates">Manage more certificates</a></li>
