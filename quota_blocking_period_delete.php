<?php
    $title = "Delete quota blocking period";
...
<div id="wrapper" class="direction-ltr">
	...
	<ol class="govuk-breadcrumbs__list">
		...
		<li class="govuk-breadcrumbs__list-item">Delete quota blocking period</li>
	</ol>
</div>
<!-- End breadcrumbs //-->
...
<div class="app-content__header">
	<h1 style="margin-bottom:0px" class="govuk-heading-xl">Delete quota blocking period</h1>
</div>
<p style="xmargin-bottom:2em">You will delete the following quota blocking period:</p>
<table class="govuk-table" style="width:66%" cellspacing="0">
    ...
    <tr>
        <th class="govuk-table__header nopad">Quota blocking period</th>
        <td class="govuk-table__cell">01 Sep 2019 to 15 Sep 2109</td>
    </tr>
    <tr valign="top">
        <th class="govuk-table__header nopad" style="vertical-align:top !important">Blocking type</th>
        <td class="govuk-table__cell">Block the allocations for a quota after its reopening due to the reception of quota return requests</td>
    </tr>
    <tr>
