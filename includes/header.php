    ...
    if (strpos($s, "global_tariff") !== false) {
        // header for global tariff only
?>
    <header class="govuk-header" role="banner" data-module="govuk-header">
        <div class="govuk-header__container govuk-width-container">
            <div class="govuk-header__logo">
                <a href="http://www.gov.uk/" class="govuk-header__link govuk-header__link--homepage">
                ...
                <a href="/global_tariff/" class="govuk-header__link govuk-header__link--homepage"><span class="env_gt">The UK Global Tariff</span></a>
            </div>
