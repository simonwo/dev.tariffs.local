<?php
    $title = "Delete quota association";
...
<div id="wrapper" class="direction-ltr">
	...
	<ol class="govuk-breadcrumbs__list">
		...
		<li class="govuk-breadcrumbs__list-item">Delete quota association</li>
	</ol>
</div>
<!-- End breadcrumbs //-->
...
<div class="app-content__header">
	<h1 style="margin-bottom:0px" class="govuk-heading-xl">Delete quota association</h1>
</div>
<p style="xmargin-bottom:2em">You will delete the following quota association:</p>
<table class="govuk-table" style="width:66%" cellspacing="0">
    <tbody>
    <tr>
        <th class="govuk-table__header nopad">Parent quota order number</th>
        <td class="govuk-table__cell">090006</td>
    </tr>
    <tr>
        <th class="govuk-table__header nopad">Parent quota definition period</th>
        <td class="govuk-table__cell">01 June 2019 to 30 May 2020</td>
    </tr>
    <tr>
        <th class="govuk-table__header nopad">Child quota order number</th>
        <td class="govuk-table__cell">090009</td>
    </tr>
    <tr>
        <th class="govuk-table__header nopad">Child quota definition period</th>
        <td class="govuk-table__cell">01 June 2019 to 30 May 2020</td>
    </tr>
    <tr>
        <th class="govuk-table__header nopad">Quota association</th>
        <td class="govuk-table__cell">01 Sep 2019 to 15 Sep 2109</td>
    </tr>
    <tr>
        <th class="govuk-table__header nopad" style="vertical-align:top !important">Relation type</th>
        <td class="govuk-table__cell">EQ</td>
    </tr>
    <tr>
        <th class="govuk-table__header nopad" style="vertical-align:top !important">Co-efficient</th>
        <td class="govuk-table__cell">1.73000</td>
    </tr>
    </tbody>
</table>
