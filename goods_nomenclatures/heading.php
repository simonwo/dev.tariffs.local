        ...
        <main class="govuk-main-wrapper" id="main-content" role="main">
            <div class="govuk-grid-row">
                <div class="govuk-grid-column-full">
                    ...
                    ?>
                    <table cellspacing="0" class="govuk-table sticky" id="table">
                        ...
                        ?>
                                <tr class="govuk-table__row">
                                    ...
                                    ?>
                                        <td class="govuk-table__cell"><a class="govuk-link" href="commodity.html?section_id=<?= $goods_nomenclature->section_id ?>&goods_nomenclature_item_id=<?= $heading->goods_nomenclature_item_id ?>&productline_suffix=<?= $heading->productline_suffix ?>&goods_nomenclature_sid=<?= $heading->goods_nomenclature_sid ?>#table"><?= $heading->description ?></a></td>
                                    <?php
                                    ...
                                    <td class="govuk-table__cell c" nowrap>
                                        <a class="icon govuk-link" href="<?= $url ?>"><img src='/assets/images/view.png' alt='View this commodity' /><span>View commodity</span></a>
                                    </td>
                                </tr>
                        <?php
                            }
