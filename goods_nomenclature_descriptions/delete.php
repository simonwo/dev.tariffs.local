            ...
            <div class="govuk-grid-row">
                <div class="govuk-grid-column-three-quarters">
                    ...
                    <form action="/additional_codes/actions.php" method="get">
                        ...
                        <?php
                        new warning_control(
                            $text = "<span class='highlighted_text'>You have opted to delete the existing additional code description for " . short_date($additional_code->validity_start_date) . ":<br /><br /><strong>" . $additional_code->description . "</strong><br /><br />By selecting 'Yes' below, you will delete the this description. This action cannot be undone.</span>",
                        );
