...
<!-- End breadcrumbs //-->
    ...
    <div class="panel panel--confirmation">
        <h1 class="heading-xlarge" style="width:1800px !important">New quota association submitted</h1>
        <p class="heading-medium">1 new quota association has been submitted for cross-check.</p>
    </div>

    <h3 class="heading-medium m-t-100">Next step</h3>
    <ul class="list next-steps">
        <li><a href="#">Withdraw submission/edit quota association</a></li>
        <li><a href="#">Create more quota associations</a></li>
        <li><a href="#">View these quota associations</a></li>
