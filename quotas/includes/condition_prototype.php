<div class="govuk-grid-row">
    <div class="govuk-grid-column-full">
        <?php
        global $quota_order_number, $application;
        $application->get_measure_condition_codes();
        $application->get_measure_actions();
        new table_control($quota_order_number->measure_activity->condition_list, "condition_table", "<p class='govuk-body' style='margin-top:2em;margin-bottom:2em'>There are currently no conditions assigned to the current activity(s).</p>", "condition_code");
        ?>
        <form action="quota_activity_actions.php" class="data_entry_form" method="post" novalidate>
            <?php
