...
<div class="app-content__header">
	<h1 style="margin-bottom:0px" class="govuk-heading-xl">Create quota blocking period</h1>
</div>
<p style="margin-bottom:2em">
    Use this functionality to create a blocking period for a given quota<br /><br />
...
<div class="govuk-form-group <?=$error_handler->get_error("quota_order_number_id");?>">
	...
	<input value="<?=$quota_blocking_period->quota_order_number_id?>" class="govuk-input" style="width:10%" id="quota_order_number_id" name="quota_order_number_id" type="text" maxlength="6" size="6">
</div>
