...
if ($application->mode == "insert") {
    $verb = "created";
    $crumb_text = "Create a new additional code";
} else {
    $verb = "updated";
    $crumb_text = "Edit additional code";
}
                ...
                <div class="govuk-grid-column-full">
                    ...
                    <div class="govuk-panel govuk-panel--confirmation">
                        <h1 class="govuk-panel__title">
                            Additional code <?= $additional_code->additional_code_type_id ?><?= $additional_code->additional_code ?> has been <?= $verb ?>.
                        </h1>
